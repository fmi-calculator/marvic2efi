...
out_gpp <- ncdf4::ncvar_get(out_nc, "GPP")
...
## Global attributes
target_id <- "YOUR_TARGET_ID" # this is a unique identifier (e.g., URL or DOI) that links to data or metadata about what the forecast/prediction is being scored against
model_name <- "YOUR_MODEL_NAME"
model_version <- "YOUR_MODEL_VERSION"
iteration_id <- "20180101T000000" #`iteration_id` represents a unique ID for each run. Examples might be a start time or database ID.
